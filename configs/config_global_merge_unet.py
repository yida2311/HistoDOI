...
class Config:
    def __init__(self, mode, train=True):
        ...
        self.batch_size = 4
        self.ckpt_path = '/home/ldy/HistoDOI/results-v3/saved_models/unet-global-merge-resnet34-ce-poly-0.0001-120-[12-23-19]-train/unet-resnet34-98-0.90519.pth' # pretrained model
        self.num_workers = 4
